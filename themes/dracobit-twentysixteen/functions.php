...
include_once get_template_directory() . '/inc/team-metabox.php';
...
include_once get_template_directory() . '/inc/class-wp-json-team.php';
...
function dracobit_endpoints_init() {
	...
	$team_endpoint     = new WP_JSON_Team();
	...
	add_filter( 'json_endpoints', array( $team_endpoint, 'register_routes' ) );
	add_filter( 'json_prepare_post', array( $team_endpoint, 'data' ), 10, 3 );
	add_action( 'json_insert_post', array( $team_endpoint, 'update_post_meta' ), 10, 3 );
