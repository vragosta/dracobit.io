...
function dracobit_tutorials_meta_box_callback( $post ) {
	...
	<table style="width: 100%;">
		<tr>
			<td>
				<label for="chapters"><?php echo esc_html( __( 'Contributors:', 'dracobit' ) ); ?></label>
			</td>
			<td>
				<textarea type="text" name="contributors" style="width: 100%;"><?php echo esc_html( $contributors ); ?></textarea>
			</td>
		</tr>
		<tr>
			<td>
